      ...
      <div className="w-full max-w-md">
        <div className="bg-apex-s1 border border-apex-bdr rounded-2xl p-8">
          <div className="mb-8">
            ...
            <p className="text-apex-txt2">Accede a tu cuenta</p>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-apex-txt2">
            ¿No tienes cuenta?{' '}
            <Link href="/signup" className="text-apex-gold hover:text-apex-gold2">
              Regístrate aquí
            </Link>
          </p>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-apex-txt3">
          Demo CRM | Credenciales: usa tus datos de Supabase
        </p>
      </div>
    </div>
  )
